...
class VerticalScrolledFrame:
    ...
    def __init__(self, master,bg, **kwargs):
        ...
        self.outer = tk.Frame(master, bg=bg,**kwargs)

        self.vsb = tk.Scrollbar(self.outer, orient=tk.VERTICAL)
        self.vsb.pack(fill=tk.Y, side=tk.RIGHT)
        self.canvas = tk.Canvas(self.outer, highlightthickness=0, width=width+10, height=height,bg=bg)
...
if __name__ == "__main__":
    ...
    frame = VerticalScrolledFrame(root, width=300, borderwidth=2, relief=tk.SUNKEN, bg="blue")
